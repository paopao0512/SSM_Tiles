...
<div id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
        <div class="item active">
            <img alt="First slide" src="${pageContext.request.contextPath}/data/imges/547567.jpg">
        </div>
        <div class="item">
            <img alt="Second slide" src="${pageContext.request.contextPath }/data/imges/547567.jpg">
        </div>
        <div class="item">
            <img alt="Third slide" src="${pageContext.request.contextPath }/data/imges/547567.jpg">
        </div>
        <div class="item">
            <img alt="Third slide" src="${pageContext.request.contextPath }/data/imges/547567.jpg">
        </div>
        <a data-slide="prev" href="#myCarousel" class="carousel-control left">
            <i class="icon-left"><img src="${pageContext.request.contextPath }/data/imges/54354.png"></i>
        </a>
        <a data-slide="next" href="#myCarousel" class="carousel-control right">
            <i class="icon-right"><img src="${pageContext.request.contextPath }/data/imges/4525424.png"></i>
        </a>
    </div>
</div>
...
<div class="main container">
    ...
    <div class="main-a row">
            ...
            <div class="row text-center">
                <ul class="list-unstyled">
                    <li class="col-xs-12 up-1">
                        <img alt="" src="${pageContext.request.contextPath }/data/imges/45354312.png">
                    </li>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
            <div class="row text-center">
                <ul class="list-unstyled">
                    <li class="col-xs-12 up-1">
                        <img alt="" src="${pageContext.request.contextPath }/data/imges/879789.png">
                    </li>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
            <div class="row text-center">
                <ul class="list-unstyled">
                    <li class="col-xs-12 up-1">
                        <img alt="" src="${pageContext.request.contextPath }/data/imges/786453654365.png">
                    </li>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 text-center">
            <p>
                <img src="${pageContext.request.contextPath }/data/imges/453254312.png">${items1}<br>
                <span class="up-3">累计在线学习人数</span>
            </p>
            <p>
                <img src="${pageContext.request.contextPath }/data/imges/453254312.png">${items}<br>
    ...
    <div class="row main-bottom">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <ul class="logo">
                <li>
                    <a href=""><img src="${pageContext.request.contextPath }/data/imges/123132.png"></a>
                </li>
                <li>
                    <a href=""> <img src="${pageContext.request.contextPath }/data/imges/1549865.png"></a>
                </li>
                <li>
                    <a href=""> <img src="${pageContext.request.contextPath }/data/imges/785345.png"></a>
                </li>
                <li>
                    <a href=""> <img src="${pageContext.request.contextPath }/data/imges/1471.png"></a>
                </li>
                <li>
                    <a href="">  <img src="${pageContext.request.contextPath }/data/imges/7861.png"></a>
                </li>
            </ul>
        </div>
    </div>
